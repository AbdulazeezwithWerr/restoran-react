...
and customize to your heart’s content. Get started by checking out our 
</span>
<span className='span-text-3'>
free preview components, or browsing all of the examples in the categories you're
most curious about.
</span>
</div>
</div>
...
<div className='button-class'>
    ...
    >
     <Link to='/afitsant'>
     <Button onClick={HandleClick} className='try-btn' sx={{marginLeft:'10vw',textDecoration: 'none', backgroundColor:"rgb(60, 107, 90)"}} variant='contained'>Try it Out</Button></Link>
     </Link>
    <Link to='/blyudo'><Button variant='outlined' sx={{color: "rgb(60, 107, 90)"}}>Our TIco menu</Button></Link>
</div>
